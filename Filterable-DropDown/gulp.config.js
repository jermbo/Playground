...
module.exports = () => {
    const config = {
            ...
            devURL: env.devURL,
            styles: {
                source: `${env.basePath}/styles/**/*.{scss, sass}`,
                build: `${env.deployPath}/`
            },
            html: {
                source: [`${env.basePath}/**/*.{html, htm, cshtml}`, '!node_modules/**'],
                build: `${env.deployPath}/`
            },
            scripts: {
                source: `${env.basePath}/js/**/*.js`,
                build: `${env.deployPath}/js`
            },
            images: {
                source: `${env.basePath}/images/**/*.*`,
                build: `${env.deployPath}/images`
            },
            browserSync: {
                port: 3000,
                ghostMode: {
            ...
            options: {
                autoPrefixerOptions: ['last 8 versions', '> 5%'],
                formatting: {
                    'indent_size': 4,
                    'indent_char': ' ',
